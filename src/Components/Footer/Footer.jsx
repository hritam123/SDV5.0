...
import { faTwitterSquare, faYoutubeSquare } from '@fortawesome/free-brands-svg-icons'; // Import Twitter icon from brands package;
...
import { faYoutube } from '@fortawesome/free-brands-svg-icons'; // Import Twitter, Facebook, GitHub, LinkedIn, and Instagram icons from brands package
      ...
      <div className="footer-content">
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name" style={{marginTop:"40px"}}><strong>Useful Links:</strong></h2>
            <ul id="menu-company" className="footer-menu-list">
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <Link to='/components'><strong>Components</strong></Link>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
        ...
        <div  className="footer-social-links"> <svg style={{height:"60px",width:"60px"}} className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <Link className="footer-social-link linkedin" to='https://www.linkedin.com/company/sae-india-nit-dgp-collegiate-chapter/mycompany/' target="_blank">
          ...
          <Link className="footer-social-link twitter" to='https://x.com/saeindia_nitdgp?t=aM3zgCd4NvAOrK4Oz887pQ&s=09' target="_blank">
          ...
          <Link className="footer-social-link youtube" to='https://youtube.com/@saenitdurgapurcollegiatech7397?si=P9NK0f0iHP9tlgYO' target="_blank">
          ...
          <Link className="footer-social-link github" to='https://www.facebook.com/SAENITD?mibextid=gik2fB' target="_blank">
